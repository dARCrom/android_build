...
""" % bcb_dev)
  ...
  script.Print("")
  script.Print("   _ _____ _____ _____               ")
  script.Print(" _| |  _  | __  |     |___ ___ _____ ")
  script.Print("| . |     |    -|   --|  _| . |     |")
  script.Print("|___|__|__|__|__|_____|_| |___|_|_|_|")
  script.Print("")
  script.Print("    >> THANK YOU FOR FLASHING! <<    ")
  script.Print("")
  script.Print("ROM Information:")
  script.Print("- Android 7.1.1 || SDK 25")
  script.Print("- DU v11.2")
  script.Print("- dARCrom v0.?-DEV")
  script.Print("")
  script.Print("Get in touch and support this project")
  script.Print("- suggest Features")
  script.Print("- report Bugs")
  script.Print("- Contributing (translation/development)")
  script.Print("- Donating")
  script.Print("")
  script.Print("- (c) 2017 dARCrom Project")
  script.Print("https://github.com/dARCrom")
  script.Print("")
